...
export default function BimeBadaneForm(props) {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      setShowNotification({
        isOpen: true,
        message: 'ذخیره سازی بیمه بدنه انجام نشد',
        type: 'error'
      });
    }
    setSaving(false);
  ...
  console.log('bimeBadaneForm ====>', isLoading);
  return (
    <>
      <BlockUi
